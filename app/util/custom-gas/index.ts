/* eslint-disable @typescript-eslint/no-explicit-any -- TODO: Replace legacy gas option bags with transaction controller types. */
 ...
 */
export function apiEstimateModifiedToWEI(estimate: any) {
 ...
 */
export function convertApiValueToGWEI(val: any) {
 ...
 * @returns {Object} - BN instance containing gas price in wei
 */
export function getWeiGasFee(estimate: any, gasLimit = 21000) {
 ...
 * @returns {Object} - BN instance containing gas price in wei
 */
export function getRenderableEthGasFee(estimate: any, gasLimit = 21000) {
 ...
 */
export function parseWaitTime(min: any) {
  let tempMin = min,
    parsed = '',
    val;
  const timeUnits = [
